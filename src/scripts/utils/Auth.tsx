  ...
  let functions = {
    async signUp(email: string, password: string) {
      try {
        ...
        setError(
          'There was a problem creating an account. Make sure the information is valid and try again.',
        )
      }
    },
    async signIn(email: string, password: string) {
      try {
        ...
        try {
          ...
          alert(err)
          setError(
            'There was a problem signing in. Check your email and password and try again.',
          )
        }
      }
    },
    ...
    async resetPassword(email: string) {
      try {
        ...
        setError(
          'Uh oh! There was a problem sending the password reset email. Try again later.',
        )
      }
    },
    async updatePassword(password: string) {
      try {
        ...
        setError(
          'Uh oh! There was a problem updating your password. Try again later.',
        )
      }
    },
    async updateEmail(email: string) {
      try {
        ...
        setError(
          'Uh oh! There was a problem updating your email. Try again later.',
        )
      }
    },
    async sendEmailVerification() {
      try {
        ...
        setError(
          'Uh oh! There was a problem sending the verification email. Try again later.',
        )
      }
    },
    async googleSignUp(email?: string, password?: string) {
      try {
        ...
        setError(
          err || 'There was a problem signing up with Google. Try again later.',
        )
        await signOut(auth)
      }
    },
    async googleSignIn(email?: string, password?: string) {
      try {
        ...
        setError(
          err ||
            'There was a problem signing in with Google. Try another method.',
        )
      }
    },
    async removeUser() {
      try {
        ...
        setError(
          err || 'There was a problem deleting your account. Try again later.',
        )
      }
    },
    async updateUserDetails(data: UserInfo) {
      try {
        ...
        for (const [key, value] of Object.entries(data))
          if (userDetails.exists() && userDetails.data()[key] !== value)
        ...
        setError(
          err || 'There was a problem updating your details. Try again later.',
        )
      }
    },
  }
